    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col">
      ...
      <div className="flex-1 max-w-lg mx-auto w-full px-4 py-6">
        {step === 1 && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-sky-600 text-white rounded-xl py-3 text-base font-semibold hover:bg-sky-700 disabled:opacity-50 mt-4"
            >
              Next
            </button>
          </div>
        ...
        {step === 2 && (
          <div className="space-y-4">
            <p className="text-sm text-zinc-500 mb-2">
              This helps CoAssure adapt to your experience level. No judgement &mdash; it just means the conversation respects what you already know.
            </p>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setFormData(prev => ({ ...prev, years_with_company: e.target.value }))}
                className="w-full rounded-xl border border-zinc-300 dark:border-zinc-600 px-4 py-3 text-base bg-white dark:bg-zinc-800 dark:text-white"
                placeholder="e.g. 3"
                min="0"
              />
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button
                onClick={() => setStep(3)}
                className="flex-1 bg-sky-600 text-white rounded-xl py-3 text-base font-semibold hover:bg-sky-700"
              >
                Next
              </button>
            </div>
        ...
        {step === 3 && (
          <div className="space-y-4">
            <p className="text-sm text-zinc-500 mb-2">
              Optional &mdash; for sending session summaries and reports.
            </p>
            <div>
            ...
            <button
              onClick={handleSubmit}
              disabled={saving}
              className="w-full text-sm text-zinc-400 hover:text-zinc-600 mt-2"
            >
